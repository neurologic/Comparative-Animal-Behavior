...
::::{margin}
:::{figure} /images/ttfl-conductance-coupling.png
:width: 500

From [Generation of circadian rhythms in the suprachiasmatic nucleus](https://doi.org/10.1038/s41583-018-0026-z): TTFLs orchestrate changes in Na+ and K+ conductances and [Ca2+]i that drive the SCN neuron between daytime electrical activity and nocturnal quiescence. The circadian profile of [Ca2+]i is directed by several mechanisms: voltage-gated channels activated by electrical firing, Ca2+ release from intracellular stores and neuropeptide signalling via G protein-coupled receptors (GPCRs) and NMDA-type glutamate receptors (NMDARs) activated by the retinohypothalamic tract. Changes in [Ca2+]i provide access to the TTFL via Ca2+/cAMP response elements (CREs) on the period (PER) genes, and, as a consequence, various circadian outputs become inputs to the TTFL, enhancing its stability and precision. 
:::
::::
...
:::{image} /images/circannual-modulation-circadian.png
:width: 600
:::
...
:::{image} /images/endogenous-circannual-reproductive.png
:width: 700
:::
...
- [Jenna R. M. Harvey, Amber E. Plante, and Andrea L. Meredith (2019) Ion Channels Controlling Circadian Rhythms in Suprachiasmatic Nucleus Excitability](https://doi.org/10.1152/physrev.00027.2019)